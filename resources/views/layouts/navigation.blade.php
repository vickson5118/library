<nav class="w-full">
    <div class="bg-[#2a2e32] fixed top-0 bottom-0 left-0 w-72 overflow-auto">
        ...
        <div class="bg-[#596643] min-h-24 w-full">
            <div class="flex items-center relative">
                @auth
                    ...
                    <a href="{{ route('profile.edit') }}" class="text-white text-2xl ml-12 mt-8">Vickson</a>
                @endauth
            </div>
        </div>
        ...
        <div class="left-menu-container">
            ...
            <form action="{{ route('logout') }}" method="post" class="mt-10 ml-10">
                @csrf
                @method('post')

                <button type="submit" class="block text-white text-center text-md py-2 px-12 hover:bg-gray-500 rounded-2xl">
